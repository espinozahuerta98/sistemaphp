...
switch ($_GET["op"]){
	...
	case 'guardaryeditar':
		...
		if (empty($idarticulo)){
			...
			echo $rspta ? "Artículo registrada" : "Artículo no se pudo registrar";
		}
		else {
			$rspta=$articulo->editar($idarticulo,$idcategoria,$codigo,$nombre,$stock,$descripcion,$imagen);
			echo $rspta ? "Artículo actualizada" : "Artículo no se pudo actualizar";
	...
	case 'desactivar':
		...
		echo $rspta ? "Artículo Desactivada" : "Artículo no se pudo desactivar";
		break;
