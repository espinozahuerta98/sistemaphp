    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <table id="tblarticulos" class="table table-striped table-bordered table-condensed table-hover"cellpadding="0" cellspacing="0" width="100%" role="grid" aria-describedby="tblArticulosIng_info" style="width: 100%;">
            <thead>
                <th>Opciones</th>
                <th>Nombre</th>
                <th>Categoría</th>
